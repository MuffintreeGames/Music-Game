...
mergeInto(LibraryManager.library,
    {
        InitFileLoader: function (callbackObjectName, callbackMethodName, callbackMethodName2) {
            ...
            FileCallbackMethodName2 = UTF8ToString(callbackMethodName2);
                        ...
                        reader.onload = function (e) {
                         audio.src = e.target.result
                           audio.addEventListener('durationchange', function() {
                            ...
                            SendMessage(FileCallbackObjectName, FileCallbackMethodName2, length);
                          },false);
